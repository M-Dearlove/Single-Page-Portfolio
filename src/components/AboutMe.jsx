        ...
        <PageLayout title="About Me">
            <div className="about-content">
                ...
                <div className="bio-text">
                    ...
                    <p>I’ve had the privilege to work on a variety of projects, including Ship-N-Go, a site showcasing my skills in basic HTML, CSS, and JavaScript using Materialize, and Spoonfed, a full PERN stack application that allows the user to search for recipes by ingredient and integrates AI to generate personalized recipes. Both projects reflect my commitment to blending clean design with robust functionality.</p>
